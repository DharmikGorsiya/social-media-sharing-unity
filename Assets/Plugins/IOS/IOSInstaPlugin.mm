...
-(void) share:(NSString *)status media:(NSString *)media {
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 5.0) {
        ...
        UnitySendMessage("IOSInstagramManager", "OnPostFailed", [SPDataUtility NSStringToChar:@"3"]);
        ...
        if ([MGInstagram isAppInstalled]) {
            ...
            UnitySendMessage("IOSInstagramManager", "OnPostFailed", [SPDataUtility NSStringToChar:@"1"]);
...
- (void)documentInteractionControllerDidDismissOpenInMenu:(UIDocumentInteractionController *)controller {
    ...
    UnitySendMessage("IOSInstagramManager", "OnPostFailed", [SPDataUtility NSStringToChar:@"2"]);
}


- (void) documentInteractionController: (UIDocumentInteractionController *) controller willBeginSendingToApplication: (NSString *) application {
     NSLog(@"willBeginSendingToApplication");
    UnitySendMessage("IOSInstagramManager", "OnPostSuccess", [SPDataUtility NSStringToChar:@""]);
}
